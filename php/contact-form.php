...
if(isset($_POST["action"])) {
	...
	$headers = 'From: A Bostrad Website Visitor <info@bostrad.com>' . "\r\n";

	$to = 'info@bostrad.com';     // Recipient's email address
	$subject = 'Inquiry Form Submission - Bostrad '; // Message title
...
function validation_google_captcha( $captch_response){
	...
	$captch_secret_key = '6Lf8YZ8UAAAAAD8g5r5idz9s9ehgeOA8KzbMNbom';
